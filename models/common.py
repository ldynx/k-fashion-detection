...
class DetectMultiBackend(nn.Module):
    ...
    def forward(self, im, augment=False, visualize=False, extract=False):
        ...
        if self.pt:  # PyTorch
            y = self.model(im, augment=augment, visualize=visualize, extract=extract) if augment or visualize or extract else self.model(im)
